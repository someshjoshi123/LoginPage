...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(String firstname, String lastname, String gender, String email, String password){
    ...
    public ArrayList<ModelClass> getUserData(String gender){
        ...
        if(cursor.getCount() != 0){
            ...
            while (cursor.moveToNext()){
                ...
                modelClassArrayList.add(new ModelClass(user_fName, user_lName, user_gender, user_email));
            }
